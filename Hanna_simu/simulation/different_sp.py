...
nof_dimensions  = 10
only_gen        = 1 # 0 or 1 in bash

initial_memory  =  0
   
rho_cases = 100
initial_memory  =  np.arange(-3, 3.5, 0.5)
maxgen= 10000
...
if only_gen:
        og= 'onlygen'
        filename = f'gens{maxgen}_dims{nof_dimensions}_onlygen.pkl'
else: 
        og= 'epi'
        filename = f'gens{maxgen}_dims{nof_dimensions}_mutrate{mutrate[0]}.pkl'
