...
folder_path  = '/home/usriniva/Desktop/Phd/Epigenetics/Simulations/New_Hanna_eqns/Hanna_simu/results/new_results/finegrain_100_100_env'
    

    
    #only genetics filename
if only_gen:
        og= 'onlygen'
        filename = f'rhos{rho_cases}_ms{m_cases}_gens{max_gen}_dims{nof_dimensions}__mutrate{mutrate[0]}_onlygen.pkl'
else: 
        og= 'epi'
        filename = f'rhos{rho_cases}_ms{m_cases}_gens{max_gen}_dims{nof_dimensions}_mutrate{mutrate[0]}.pkl'
